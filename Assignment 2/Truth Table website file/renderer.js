/* Function: prettyPrintTruthTable - Outputs an elegantly-formatted truth table for the given parsed expression. */
...
/* Function: createTableElement - Creates a new table element and sets up its properties. */
function createTableElement() {
	var result = document.createElement("table");
	result.className = "truthTable";
	return result;
}
/* Function: createTableHeader - Given a table representing the result of the truth table, creates the header for the table by listing the variables and the expression in separate columns. */
...
/* Function: outputRow - Given a table to output a row to, creates a callback that outputs a row to that table. */
...
/* Function: displayTable - Displays the specified truth table in the window. */
...
/* Function: showObject - Displays the specified HTML object in the output box. */
...
/* Function: displayCompileError - Displays the specified compilation error message. The first parameter should be the actual string provided as input, and the second the error message that was generated. */
...
/* Function: createHighlightedErrorBox - Given the text input and the reported error information, creates an HTML element highlighting the given error. */
...
/* Function: createDescriptionBox - Given an error, creates an HTML box containing that error. */
